...
6. Рейтинг Тинькофф может не соответствовать тому, что написано в мобильном приложении. Проблема известна, описание и запрос на исправление здесь: https://github.com/Tinkoff/invest-python/issues/204
